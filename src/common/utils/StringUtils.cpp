...
namespace eurora::common {
    ...
    std::string StringUtils::JoinString(
    ...
    )
    {
        ...
        auto func = [&aSeparator](const std::string& aA, const std::string& aB) {
            return aA + aSeparator + aB;
        };
    ...
    void
    StringUtils::ReplacedAllByRegex(
        std::string&                                    aSource,
        const std::string&                              aReplacedPattern,
        const std::string&                              aNew
    )
