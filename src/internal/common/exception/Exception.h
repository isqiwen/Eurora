...
#define EURORA_MAKE_SIMPLE_EXCEPTION(exceptionName)                                   \
    ...
    public:                                                                           \
        exceptionName(  const std::string& description = "",                          \
                        const std::string& file = __FILE__,                           \
                        int line = __LINE__)                                          \
            : eurora::common::Exception(eurora::common::ErrorCode::UnknownError,      \
                                        std::string(#exceptionName) + ": " + description, \
                                        file, line) {}                                \
    };
...
#define EURORA_MAKE_SIMPLE_EXCEPTION_WITH_CODE(exceptionName, errorCode)             \
    ...
    public:                                                                          \
        exceptionName(  const std::string& description = "",                         \
                        const std::string& file = __FILE__,                          \
                        int line = __LINE__)                                         \
            : eurora::common::Exception(errorCode,                                   \
                                        std::string(#exceptionName) + ": " + description, \
                                        file, line) {}                               \
    };
